...
const drugSpecs = {
  ...
  Nitroglycerin:     { concentration: 0.5,  unit: "mg/ml",  rateUnit: "mcg/kg/min", decimalPlace: 2 },
  Labetalol:         { concentration: 5,    unit: "mg/ml",  rateUnit: "mg/kg/hr",   decimalPlace: 2 },
  ...
  Morphine:          { concentration: 10,   unit: "mg/ml",  rateUnit: "mcg/kg/min", decimalPlace: 2 },
  Lorazepam:         { concentration: 2,    unit: "mg/ml",  rateUnit: "mg/kg/hr",   decimalPlace: 2 },
  Ketamine:          { concentration: 50,   unit: "mg/ml",  rateUnit: "mcg/kg/min", decimalPlace: 1 },
  Propofol:          { concentration: 10,   unit: "mg/ml",  rateUnit: "mcg/kg/min", decimalPlace: 2 },
  MgSO4:             { concentration: 100,  unit: "mg/ml",  rateUnit: "mg/kg/hr",   decimalPlace: 1 },
  Lidocaine:         { concentration: 50,   unit: "mg/ml",  rateUnit: "mcg/kg/min", decimalPlace: 2 },
  ...
  Jusomin:           { concentration: 0.83, unit: "mEq/ml", rateUnit: "mEq/kg/hr",  decimalPlace: 1 },
  Octreotide:        { concentration: 100,  unit: "mcg/ml", rateUnit: "mcg/kg/hr",  decimalPlace: 1 },
  Amiodarone:        { concentration: 50,   unit: "mg/ml",  rateUnit: "mcg/kg/min", decimalPlace: 1 },
};
...
export function init(root) {
  ...
  if (typeof bindMutualDisableBySelector === "function") {
